...
#define UVC_CONFIG_DESC_SIZ                           0xAFU
#else
...
#define VIDEO_IN_TERMINAL_DESC_SIZE                   0x11U
#define VIDEO_OUT_TERMINAL_DESC_SIZE                  0x09U
#define VIDEO_VS_IF_IN_HEADER_DESC_SIZE               0x0EU
#define VIDEO_VC_SPECIFIC_TOTAL_SIZE                  (VIDEO_VC_IF_HEADER_DESC_SIZE + VIDEO_IN_TERMINAL_DESC_SIZE + VIDEO_OUT_TERMINAL_DESC_SIZE)
